...
This directory is set up as a Home Assistant app repository.

## Included apps

- `dispatcharr/`: IPTV, EPG, and VOD stream management companion
...
`https://github.com/IAmStiven/homeassistant-apps`
...
[repository-url]: https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A//github.com/IAmStiven/homeassistant-apps
